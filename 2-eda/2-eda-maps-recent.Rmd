...
```{r recent-tot}
title_recent <- paste0("Agricultural Performance Q",
                       (as.numeric(str_sub(max(state_recent$year), -1)) + 1) %% 4,
                          " ", str_sub(max(state_recent$year - 1), 1, 4),
                       " to Q", str_sub(max(state_recent$year), -1),
                          " ", str_sub(max(state_recent$year), 1, 4))
# subtitle_recent <- paste0("12-month period ending after Q",
#                           str_sub(max(state_recent$year), -1),
#                           " ",
#                           str_sub(max(state_recent$year), 1, 4))
subtitle_recent <- paste0("Avg Total Ag Loan Value of ", tot_value,
                          "\nDeliquency Rate of ", tot_delin)
...
```{r recent-prod}
title_recent <- paste0("Agricultural Production Performance Q",
                       (as.numeric(str_sub(max(state_recent$year), -1)) + 1) %% 4,
                          " ", str_sub(max(state_recent$year - 1), 1, 4),
                       " to Q", str_sub(max(state_recent$year), -1),
                          " ", str_sub(max(state_recent$year), 1, 4))
...
#                           " ",
#                           str_sub(max(state_recent$year), 1, 4))
subtitle_recent <- paste0("Avg Total Production Loan Value of ", prod_value,
                          "\nDeliquency Rate of ", prod_delin)
...
```{r recent-re}
title_recent <- paste0("Agricultural Real Estate Performance Q",
                       (as.numeric(str_sub(max(state_recent$year), -1)) + 1) %% 4,
                          " ", str_sub(max(state_recent$year - 1), 1, 4),
                       " to Q", str_sub(max(state_recent$year), -1),
                          " ", str_sub(max(state_recent$year), 1, 4))
...
#                           " ",
#                           str_sub(max(state_recent$year), 1, 4))
subtitle_recent <- paste0("Avg Total Farmland Loan Value of ", re_value,
                          "\nDeliquency Rate of ", re_delin)
...
#                           " ",
#                           str_sub(max(state_recent$year), 1, 4))
subtitle_recent <- paste0("Avg Total Ag Loan Value of ", tot_value_oh,
                          "\nDeliquency Rate of ", tot_delin_oh)
...
#                           " ",
#                           str_sub(max(state_recent$year), 1, 4))
subtitle_recent <- paste0("Avg Total Production Loan Value of ", prod_value_oh,
                          "\nDeliquency Rate of ", prod_delin_oh)
...
#                           " ",
#                           str_sub(max(state_recent$year), 1, 4))
subtitle_recent <- paste0("Avg Total Farmland Loan Value of ", re_value_oh,
                          "\nDeliquency Rate of ", re_delin_oh)
